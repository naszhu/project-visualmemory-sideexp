...
sent2=' you will be presented with a study list of 2 or 4 pictures.';
...
sent5=' press the J key (OLD) as quickly as possible.';
sent6='If the test picture was not a member of the study list,';
sent7=' press the F key (NEW) as quickly as possible.';
...
sent12='The experiment has 2 blocks of trials with 200 trials in each block.';
