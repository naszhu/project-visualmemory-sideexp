...
if ~exist(filename)
    ...
    wss2=[0.12346,0.4,0.47654]; %weight for ss2
    wss4=[0.12346,0.8,0.07654];
    wss4=[0.12346,0.87654,0];
    ...
    for block=1:nblocks
        ...
        for trial=1:ntrials
            ...
            %% Draw test item
            if old==1
                testitem = randsample(memlist,1,true,probchart_new{cmassign,ss/2}); %there is no 3,6 
            else % New
